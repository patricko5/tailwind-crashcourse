  ...
  return (
    <div className="max-w-sm mx-auto my-2 overflow-hidden rounded shadow-lg">
      ...
      <div className="text-center">
        <button
          onClick={onNavigate}
          className="px-4 py-2 my-1 font-semibold text-blue-700 border bg-transparent border-blue-500 rounded hover:bg-blue-500 hover:text-white hover:border-transparent"
        >
          Read More
        </button>
      </div>
